...
public class Utils2 {
    ...
    public static File getModelFile(Context context, String name) {
        final String TAG = "sukshiVishwam";

//        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "/.JioAttModelUpdate/");
        File mediaStorageDir = new File(context.getFilesDir(), "JioAtt");
