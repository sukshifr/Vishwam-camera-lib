...
import static com.jukshio.jwccgateapplib.FRCaptureView.FaceDect.onCaptureListener;
import static com.jukshio.jwccgateapplib.FRCaptureView.FaceDect.onMultipleFacesDetectedListener;
import static com.jukshio.jwccgateapplib.FRCaptureView.FaceDect.onNextFrameListener;
import static com.jukshio.jwccgateapplib.FRCaptureView.ParamsView.takePicture;
import static com.jukshio.jwccgateapplib.ImageAnalysis.ImageAnalysis.canAddData;

//import static com.sukshi.vishwamattendancefrlib.ImageAnalysis.ImageAnalysis.canAddData;
//import static com.sukshi.vishwamfrlib.Tracker.FaceDect.mOnFrontalFaceDetectedListener;
//import static com.sukshi.vishwamfrlib.Tracker.FaceDect.takepicture;
//import static com.sukshi.vishwamfrlib.Tracker.FaceDect2.mOnFrontalFaceDetectedListener2;
//import static com.sukshi.vishwamfrlib.Tracker.FaceGraphic.faceArea;
...
//                onCaptureListener2.onCapture2(data1, angle);
            }else {
                if (faceSize>=1) {
                    onNextFrameListener.onSetNextFrame(data, camera.getParameters(), mPreviewSize, angle);
                }
            }
            ...
            /*if (okForAnalysis && islightEnabled) {
                Log.e("vishwam_IA_start1","here");
        ...
        /*void detectObject(byte[] data, Camera camera) {
            ...
            ImageObject imageObject = new ImageObject(data, previewW, previewH, parameters, angle,null);

            if (!inReg&& okForAnalysis){
...
//                        Log.e("vishwam2", "here");
                        ...
                        onMultipleFacesDetectedListener.onMultipleFacesDetected(faceSize);
//                        onMultipleFacesDetectedListener2.onMultipleFacesDetected2(faceSize);
                    }
